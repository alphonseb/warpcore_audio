                ...
                <div class="location-info">
                  ...
                  <div class="equipment">
                    ...
                    <ul>
                      ...
                      <li>2 NEUMANN KM 184</li>
                      <li>3 SENNHEISER E604</li>
                      <li>SENNHEISER MD 441</li>
                      <li>5 SHURE SM 57</li>
                      <li>4 SHURE SM7B</li>
                      <li>SHURE SM81</li>
                      <li>SHURE Beta 52</li>
                      <li>TELEFUNKEN CU-29</li>
                      <li>AVID PRO TOOLS 10 HD</li>
                      <li>AVID HD I/O</li>
                    </ul>
                  </div>
                </div>
                ...
                <div class="location-info">
                  ...
                  <div class="equipment">
                    ...
                    <ul>
                      ...
                      <li>2 SSL 611 EQ</li>
                      <li>2 SSL 611 DYN</li>
                      <li>ELYSIA XPRESSOR 500</li>
                      <li>ELYSIA XFILTER 500</li>
                      <li>2 UNIVERSAL AUDIO Apollo 16 QUAD</li>
                      <li>UNIVERSAL AUDIO Preamp/Comp 6176</li>
                      <li>AUDIENT ASP800 Preamp</li>
                      <li>Monitor ADAM S3X-H</li>
                      <li>Monitor NEUMANN KH 120A</li>
                      <li>AVID Artist Transport</li>
                      <li>AVID Artist Mix</li>
                      ...
                      <li>NATIVE INSTRUMENT TRAKTOR Kontrol S8</li>
